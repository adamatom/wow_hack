...
namespace Woah
{
    ...
    {
        // better method: search for list of commands in ollydbg: 
        //shl     ecx, 0Ch 
        //push    1000h
        ...
        private static int MOUSECURSOR = 0x01141B08; // version 3.1.2 //0xCF5750; // <- version 2.4.3// //0xD4EC48; // <- version 2.4.2 - In olly, right click in CPU, search for all referenced strings, search for "Cursor", look for the interface\\cursor\\xx.blp line, the address is there
...
//                 theform.sendline(input2);
            ...
            int curs = env.Memory.ReadInteger(MOUSECURSOR);
